# A.G.1 implementation tasks

Implementation started through the authorized apply request. C.P.1 trophy issuance is excluded. See F1_VERIFICATION.md for A.G.1 evidence and remaining live checks.
