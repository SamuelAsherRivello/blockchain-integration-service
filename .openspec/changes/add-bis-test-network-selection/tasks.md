...
- [ ] 4.2 Update Account restore/create, Game Wallet recovery, Admin A.G.1/A.G.2/A.G.3, balance/activity/assets/contracts, and send review surfaces to keep one selected-network context visible; verify narrow 9:16, keyboard, and role/network-rejection coverage.
