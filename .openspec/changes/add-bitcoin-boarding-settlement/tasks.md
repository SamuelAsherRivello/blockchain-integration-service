...
- [x] 3.2e Fix asset-bearing withdrawal eligibility: reserve owned asset change for Max, bind exact asset quantities in quotes, validate the SDK asset intent before registration, persist and reconcile asset change, and verify adapter regressions plus the browser review. Live transfer acceptance remains in 3.3.
