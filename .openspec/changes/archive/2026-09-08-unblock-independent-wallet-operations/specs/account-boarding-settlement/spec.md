...
- **THEN** the UI SHALL show "Transfer submitted" and "Check Transactions for updates."
- **AND** settlement continues in the background while this tab stays open; registered is not verified success
