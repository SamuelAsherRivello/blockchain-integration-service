...
- [ ] 6.2 Place the BIS host above every game visual control, including virtual controls, and add the full-screen translucent black blocking backdrop. Verify visual overlap and pointer/keyboard isolation in the user's browser.
