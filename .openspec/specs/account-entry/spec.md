...
- **AND** A3 restores account access only before entering the shared A4 dialog; balance loading belongs to A4; A5 owns all SDK-provided incoming and outgoing transaction history, and other menu features remain deferred
