...
**A.G.3 story status:** Complete ✓ — confirmed by the user on 2026-09-09.
...
#### Scenario: A.G.3 Arkade settlement
- **WHEN** a pending A.G.3 receipt for 1000 sats later has SDK-verified spendable receipt in the same active recipient session
