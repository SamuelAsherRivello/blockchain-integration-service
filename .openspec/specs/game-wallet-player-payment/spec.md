...
- **THEN** one real 1000-sat payment is submitted from A.G.1 to the preview player
...
#### Scenario: B.G.2 Arkade settlement
- **WHEN** a pending B.G.2 receipt for 1000 sats later has SDK-verified spendable receipt in the same active recipient session
