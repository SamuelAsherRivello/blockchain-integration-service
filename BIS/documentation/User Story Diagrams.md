...
| 04. Batch Operations | Admin / Batch Operations | Local-only Admin session marker controls: **Clear Last Batch** and **Start New Batch** never mutate or cancel wallet, Arkade, Marketplace, or remote operations. |
