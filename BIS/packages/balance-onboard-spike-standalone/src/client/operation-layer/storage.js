import { newRecoveryPhrase, normalizeRecoveryPhrase, restoreIdentity } from '../arkade-layer/identity-material.js';
import {databaseName,stateLocks} from './window-runtime.js';
import {createVault,cryptoWork} from '../arkade-layer/vault.js';
let vault;
