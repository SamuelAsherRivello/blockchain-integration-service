...
export const layout=`
<header class="spike-header"><div class="spike-identity"><span class="spike-mark" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M7 17 17 7M9 7h8v8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></span><div><h1>Balance Onboard</h1><p>Standalone Signet Spike</p></div></div><span class="spike-network">Signet only</span></header>
<div class="spike-single-column"><section class="spike-flow" aria-labelledby="flow-title"><h2 id="flow-title" class="workspace-title">Onboarding flow</h2><section class="balances" aria-label="Current balances"><article><label>Bitcoin</label><strong id="bitcoin">—</strong><small>Onchain sats</small></article><div class="arrow" aria-hidden="true">→</div><article><label>Arkade</label><strong id="arkade">—</strong><small id="available">Spendable sats: —</small></article></section>
...
</section><section class="spike-diagnostics" aria-label="Run diagnostics"><section class="total-duration" aria-label="Total duration of all six steps"><h2>Run timing</h2><div><span>Estimated <strong id="total-estimated">Calculating…</strong></span><span>Last observed <strong id="total-observed">No completed run yet</strong></span></div><small>Account restart → Step 6 ready, including funding and confirmations.</small></section><section class="refresh-bar"><button id="refresh" disabled>Refresh status</button><span class="muted">Last fresh check: <span id="checked">—</span></span></section><footer><span id="window-label"></span><span id="sdk"></span><span>Keep this window open during signing.</span></footer></section></div>`;
