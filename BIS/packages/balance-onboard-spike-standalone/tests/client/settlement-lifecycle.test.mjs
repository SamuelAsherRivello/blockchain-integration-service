...
import {verifiedReceipt,capturedFunding,fundingEligible,canSubmit,half} from '../../src/client/operation-layer/model.js';
import {Ramps,ArkAddress} from '@arkade-os/sdk';
import {newRecoveryPhrase,normalizeRecoveryPhrase} from '../../src/client/arkade-layer/identity-material.js';
import {queuedLocks} from './helpers.mjs';
import {WorkCoordinator,staleError,withDeadline} from '../../src/client/operation-layer/coordinator.js';
import {classifyFailure,nextRetry,recoveryMessage,batchFailure} from '../../src/client/operation-layer/recovery.js';
...
test('faucet popup rejection preserves manual funding and never implies a deposit',async()=>{
 ...
 const markup=readFileSync(new URL('../../src/client/ui-layer-react/layout.js',import.meta.url),'utf8');
