...
import { BatchOperationsPanel, type BatchOperationsLog } from './admin/BatchOperationsPanel';
...
export function App({ contextFactory = createBisContext, gameWalletFactory = createBisGameWallet }: { contextFactory?: typeof createBisContext; gameWalletFactory?: typeof createBisGameWallet } = {}) {
  ...
  const logBatchOperations = useCallback((entry: BatchOperationsLog) => {
    setConsoleLines(previous => [...previous.slice(-19), `Batch Operations\n${JSON.stringify(entry, null, 2)}`]);
  }, []);
