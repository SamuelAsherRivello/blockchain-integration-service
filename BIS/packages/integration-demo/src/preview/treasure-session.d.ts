...
export type TreasureSnapshot={id:string;reference:string;expiresAt:number;status:TreasureStatus;offered:boolean;playerId?:string;gameId?:string;contractId?:string};
