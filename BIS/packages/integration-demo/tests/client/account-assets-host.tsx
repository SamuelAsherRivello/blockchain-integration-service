...
import { createContext, getControls } from '../../../integration/src/client/state-layer-core/context';
import { createBisUi } from '@bis/integration';
import { formatAssetDetail, formatAssetDetails } from '../../../integration/src/client/state-layer-core/asset-presentation';
import type { BisAsset } from '../../../integration/src/client/state-layer-core/assets';
...
const account={phrase:'isolated-placeholder',profileId:'asset-browser-fixture',network:'mutinynet' as const};
