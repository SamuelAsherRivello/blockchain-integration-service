...
import { formatTransactionDetail, formatTransactions, type BisTransaction } from '../../../integration/src/client/state-layer-core/activity';
...
document.getElementById('run')!.onclick=async()=>{
  ...
  try{
    ...
    const copyAll=host.querySelector<HTMLButtonElement>('[aria-label="Copy Transactions"]');
    check(copyAll && !copyAll.disabled,'Copy-all available for every loaded row');
    check(copyAll?.parentElement?.querySelector('h3')?.textContent==='Transactions' && !!copyAll.querySelector('svg'),'Transactions heading with adjacent copy icon');
