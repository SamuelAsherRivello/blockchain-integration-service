...
import {readBoardingRecord,type BoardingRecord} from '../../../integration/src/client/state-layer-core/boarding-record';
import {transferStatus} from '../../../integration/src/client/state-layer-core/boarding-status';
