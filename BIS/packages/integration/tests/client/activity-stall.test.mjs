...
import {normalizeHistory,observeActivityWallet} from '../../src/client/wallet-layer-arkade/activity.ts';
...
test('mint operations show exact decimal quantities, pending status, and deduplicate known transaction IDs',async()=>{
 const {withMintActivity}=await import('../../src/client/state-layer-core/activity.ts');
