...
import {hasLiveBoardingWait} from '../../src/client/state-layer-core/live-boarding-wait.ts';
...
test('A.G.3 waits only on live unconfirmed spending of its boarding inputs',()=>{
 ...
 const {liveBoardingState}=await import('../../src/client/state-layer-core/live-boarding-wait.ts');
