...
test('public LTO factory creates and claims by default; explicit rollback keeps recovery',async t=>{
  ...
  const stubs={
    '/wallet-layer-arkade/account.ts':'export const SIGNET_OPERATOR="https://signet.arkade.sh";export const operatorFor=()=>SIGNET_OPERATOR;',
    '/state-layer-core/contract-storage.ts':prefix+'export const createContractStorage=()=>d.storage,createNetworkScopedContractStorage=()=>d.storage;',
    '/state-layer-core/account-storage.ts':prefix+'export const createAccountStorage=()=>d.playerStorage;',
