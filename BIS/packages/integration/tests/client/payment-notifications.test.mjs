...
import {createPaymentNotifications} from '../../src/client/state-layer-core/payment-notifications.ts';
...
test('A.G.3 settled receipt has an explicit confirmation and reports a new receipt only once',()=>{
